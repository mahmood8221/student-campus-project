document.addEventListener('DOMContentLoaded', function() {
    ...
    async function fetchStudyGroups() {
        try {
            ...
            // Using our PHP API
            const response = await fetch('https://replit.com/@da3ooy969classi/my-app#htdocs/api.php');
            ...
            <div class="col">
                <article class="group-card">
                    <div class="p-3 h-100">
                        ...
                        <p><strong>Meets:</strong> ${group.meeting_time}</p>
    ...
    function joinStudyGroup(e) {
        ...
        // API call to join the group
        fetch('https://replit.com/@da3ooy969classi/my-app#htdocs/api.php/join', {
            method: 'POST',
            headers: {
        ...
        .then(data => {
            ...
            // Refresh the study groups list to update member counts
            fetchStudyGroups();
        })
        .catch(error => {
